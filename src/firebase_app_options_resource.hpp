...
class FirebaseAppOptionsResource : public Resource {
    GDCLASS(FirebaseAppOptionsResource, Resource)
...
public:
    ...
    // Convert to FirebaseAppOptions
    Ref<FirebaseAppOptions> to_firebase_app_options() const;
};
